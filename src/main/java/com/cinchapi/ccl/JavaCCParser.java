...
import com.cinchapi.ccl.v2.generated.CriteriaGrammarTokenizeVisitor;
import com.cinchapi.ccl.v2.generated.CriteriaGrammarTreeVisitor;
...
/**
 * This parser utilizes {@link CriteriaGrammar} which is grammar generated by JavaCC
 */
public class JavaCCParser extends Parser {
    ...
    public Queue<PostfixNotationSymbol> order() {
        try {
            ...
            CriteriaGrammarPostfixVisitor visitor = new CriteriaGrammarPostfixVisitor(this,
                    data);
    ...
    public AbstractSyntaxTree parse() {
        try {
            ...
            SimpleNode start = grammar.Start();
            CriteriaGrammarTreeVisitor visitor = new CriteriaGrammarTreeVisitor(this, data);
    ...
    public List<Symbol> tokenize() {
        try {
            ...
            SimpleNode start = grammar.Start();
            CriteriaGrammarTokenizeVisitor visitor = new CriteriaGrammarTokenizeVisitor(this,
                    data);
