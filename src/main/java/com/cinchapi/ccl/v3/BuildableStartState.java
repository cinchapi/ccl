 ...
 * is important so that we don't allow the caller to build an empty condition or
 * a criteria with a hanging conjunction (because those conditions would simply
 * place the builder in a {@link StartState} which is un-buildable).
 * 
 * @author Jeff Nelson
 */
public class BuildableStartState extends BuildableState {
     ...
     * @param criteria
     */
    protected BuildableStartState(BuiltCondition criteria) {
        super(criteria);
    }
