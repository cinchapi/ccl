...
public class GrammarPostfixVisitor implements GrammarVisitor
{
     ...
     * @param parser
     */
    public GrammarPostfixVisitor(JavaCCParser parser) {
        this(parser, null);
    }
    ...
    public Object visit(ASTAnd node, Object data) {
        Queue<PostfixNotationSymbol> symbols = (Queue<PostfixNotationSymbol>) data;
    ...
    public Object visit(ASTExpression node, Object data) {
        ...
        if (key != null && operator != null && !values.isEmpty() && timestamp != null) {
            symbols.add(new Expression(timestamp, key, operator, values.toArray(new BaseValueSymbol[values.size()])));
        }
        else if (key != null && operator != null && !values.isEmpty()) {
            symbols.add(new Expression(key, operator, values.toArray(new BaseValueSymbol[values.size()])));
        }
