...
if (jjtc000) {
  ...
  final public BaseKeySymbol Key() throws ParseException {Token word;
  String key = "";
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return new KeySymbol(key);}
    throw new Error("Missing return statement in function");
}
  ...
  private boolean jj_3_2()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x40,0x40,0x200,0x100,0x38000088,0xc00,0x38000080,0x38000080,0x78000000,0x1000000,0x78000000,0x79000000,0x79000000,0x79000000,0x20,};
	}
