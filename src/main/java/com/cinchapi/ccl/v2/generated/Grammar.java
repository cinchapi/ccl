...
if (jjtc000) {
  ...
  Token function;
    if (jj_2_1(2)) {
      ...
      jj_consume_token(39);
      jj_consume_token(CLOSE_PARENTHESES);
ASTDynamicFunctionKey jjtn001 = new ASTDynamicFunctionKey(JJTDYNAMICFUNCTIONKEY);
      boolean jjtc001 = true;
      jjtree.openNodeScope(jjtn001);
      try {
jjtree.closeNodeScope(jjtn001, true);
      jjtc001 = false;
jjtn001.build(function.image, key.image.substring(0, key.image.length()-1));
      } finally {
if (jjtc001) {
        jjtree.closeNodeScope(jjtn001, true);
      }
  ...
  ASTStart ccl;
    if (jj_2_4(2)) {
      ...
      case ALPHANUMERIC:{
        ...
        jj_consume_token(CLOSE_PARENTHESES);
ASTImplicitFunctionValue jjtn001 = new ASTImplicitFunctionValue(JJTIMPLICITFUNCTIONVALUE);
       boolean jjtc001 = true;
       jjtree.openNodeScope(jjtn001);
        try {
jjtree.closeNodeScope(jjtn001, true);
       jjtc001 = false;
jjtn001.build(function.image, key.image);
        } finally {
if (jjtc001) {
         jjtree.closeNodeScope(jjtn001, true);
       }
...
records.add(word.image);
          jj_consume_token(CLOSE_PARENTHESES);
ASTExplicitFunctionValue jjtn002 = new ASTExplicitFunctionValue(JJTEXPLICITFUNCTIONVALUE);
       boolean jjtc002 = true;
       jjtree.openNodeScope(jjtn002);
          try {
jjtree.closeNodeScope(jjtn002, true);
       jjtc002 = false;
jjtn002.build(function.image, key.image.substring(0, key.image.length()-1), records);
          } finally {
if (jjtc002) {
         jjtree.closeNodeScope(jjtn002, true);
       }
          ...
          case COMMA_SEPARATED_ALPHANUMERIC:{
            ...
            ccl = generateSubAST();
            jj_consume_token(CLOSE_PARENTHESES);
ASTExplicitFunctionValue jjtn003 = new ASTExplicitFunctionValue(JJTEXPLICITFUNCTIONVALUE);
       boolean jjtc003 = true;
       jjtree.openNodeScope(jjtn003);
            try {
jjtree.closeNodeScope(jjtn003, true);
       jjtc003 = false;
jjtn003.build(function.image, key.image.substring(0, key.image.length()-1), ccl);
            } finally {
if (jjtc003) {
         jjtree.closeNodeScope(jjtn003, true);
       }
