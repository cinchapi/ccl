...
if (jjtc000) {
  ...
  Token function;
    if (jj_2_1(2)) {
      ...
      jj_consume_token(38);
      jj_consume_token(CLOSE_PARENTHESES);
ASTImplicitFunction jjtn001 = new ASTImplicitFunction(JJTIMPLICITFUNCTION);
      boolean jjtc001 = true;
      jjtree.openNodeScope(jjtn001);
      try {
jjtree.closeNodeScope(jjtn001, true);
      jjtc001 = false;
jjtn001.function(function.image); jjtn001.key(key.image.substring(0, key.image.length()-1));
      } finally {
if (jjtc001) {
        jjtree.closeNodeScope(jjtn001, true);
      }
...
jjtree.closeNodeScope(jjtn002, true);
       jjtc002 = false;
jjtn002.function(function.image); jjtn002.key(key.image.substring(0, key.image.length()-1)); jjtn002.records(records);
          } finally {
if (jjtc002) {
         jjtree.closeNodeScope(jjtn002, true);
       }
          ...
          case ALPHANUMERIC:{
            ccl = generateSubAST();
            jj_consume_token(CLOSE_PARENTHESES);
ASTExplicitFunctionWithCCL jjtn003 = new ASTExplicitFunctionWithCCL(JJTEXPLICITFUNCTIONWITHCCL);
       boolean jjtc003 = true;
       jjtree.openNodeScope(jjtn003);
            try {
jjtree.closeNodeScope(jjtn003, true);
       jjtc003 = false;
jjtn003.function(function.image); jjtn003.key(key.image.substring(0, key.image.length()-1)); jjtn003.ccl(ccl);
            } finally {
if (jjtc003) {
         jjtree.closeNodeScope(jjtn003, true);
       }
  ...
  private boolean jj_3_1()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x40,0x200,0x100,0xe0000088,0xc00,0x18000000,0xe0000080,0xe0000080,0x18000000,0x8000000,0x0,0xe0000088,0xe1000000,0xe1000000,0xe1000000,0xe1000000,0xe1000000,0x20,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x1,0x1,0x1,0x1,0x1,0x0,};
	}
