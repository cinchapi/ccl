...
public class Grammar/*@bgen(jjtree)*/implements GrammarTreeConstants, GrammarConstants {/*@bgen(jjtree)*/
  protected JJTGrammarState jjtree = new JJTGrammarState();private Function<String, Object> valueTransformFunction;
  ...
  Token function;
    if (jj_2_1(2)) {
      ...
      case SIGNED_INTEGER:{
        ...
        attribute = jj_consume_token(ALPHANUMERIC);
        break;
        }
      case SIGNED_DECIMAL:{
...
{if ("" != null) return new MetaAttributeKeySymbol(key.image, attribute.image);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case RESERVED_IDENTIFIER:
      case SIGNED_INTEGER:
...
{if ("" != null) return new KeySymbol(key.image);}
  ...
  final public BaseValueSymbol UnaryValue() throws ParseException {Token word;
  Token attribute;
  String value = "";
    if (jj_2_3(2)) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return new MetaAttributeValueSymbol(word.image, attribute.image);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case SIGNED_INTEGER:
      case SIGNED_DECIMAL:
...
{if ("" != null) return new ValueSymbol(transformValue(word.image.replace("\\\"", "\"")));}
  ...
  final public BaseValueSymbol BinaryValue() throws ParseException {Token word;
  String value = "";
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SIGNED_INTEGER:
    case SIGNED_DECIMAL:
  ...
  private boolean jj_3_1()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x40,0x40,0x200,0x100,0x38000088,0xc00,0x38000000,0x38000080,0x38000080,0x38000000,0xb8000000,0xb9000000,0xb8000000,0xb9000000,0xb9000000,0xb9000000,0x20,};
	}
