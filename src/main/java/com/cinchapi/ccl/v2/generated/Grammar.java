...
public class Grammar/*@bgen(jjtree)*/implements GrammarTreeConstants, GrammarConstants {/*@bgen(jjtree)*/
  protected JJTGrammarState jjtree = new JJTGrammarState();private List<Symbol> symbols = Lists.newArrayList();
  ...
  final public List<Symbol> Start() throws ParseException {
...
symbols.add(ParenthesisSymbol.RIGHT);
  ...
  final public void RelationalExpression() throws ParseException {Token k;
  Token o;
  Token v;
  Token t;
  String value = "";
  ...
  private boolean jj_3_1()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x40,0x100,0x80,0x3000008,0x3000000,0x7800000,0x7800000,0x7800000,0x7800000,0x20,0x3000000,0x7800000,0x7800000,0x7800000,0x7800000,0x20,0x3000000,};
	}
