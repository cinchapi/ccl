 ...
 */
public class Grammar/* @bgen(jjtree) */ implements
        GrammarTreeConstants,
    ...
    final public ASTStart Start()
            throws ParseException {/* @bgen(jjtree) Start */
    ...
    /** Main production. */
    @SuppressWarnings("unused")
    final public ASTStart StartCommandLine()
            throws ParseException {/* @bgen(jjtree) Start */
        ASTStart jjtn000 = new ASTStart(JJTSTART);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
    ...
    final public void RelationalExpression()
            throws ParseException {/* @bgen(jjtree) RelationalExpression */
    ...
    private boolean jj_3_1() {
        if(jj_scan_token(IDENTIFIER))
            return true;
        if(jj_scan_token(UNARY_OPERATOR))
            return true;
        return false;
    }
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x40, 0x800008, 0x800000, 0x800000, 0x20,
                0x800000, 0x20, 0x800000, };
    }
