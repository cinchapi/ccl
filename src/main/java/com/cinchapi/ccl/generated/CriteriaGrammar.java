/* CriteriaGrammar.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. CriteriaGrammar.java */
 ...
 */
public class CriteriaGrammar/*@bgen(jjtree)*/implements CriteriaGrammarTreeConstants, CriteriaGrammarConstants {/*@bgen(jjtree)*/
  protected JJTCriteriaGrammarState jjtree = new JJTCriteriaGrammarState();private Multimap<String, Object> data;
    private Function<String, Object> valueTransformFunction;
    private Function<String, Operator> operatorTransformFunction;
    private CriteriaGrammarVisitor visitor;

    public CriteriaGrammar(java.io.InputStream stream,
                Function<String, Object> valueTransformFunction,
                Function<String, Operator> operatorTransformFunction,
                CriteriaGrammarVisitor visitor) {
        this(stream, null);
        this.data = null;
...
jjtree.closeNodeScope(jjtn000, true);
    jjtc000 = false;
jjtn000.order(new OrderSymbol(key, direction, timestampString, timestampFormat, timestampNumber));
    } catch (Throwable jjte000) {
if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
      jjtc000 = false;
...
{if ("" != null) return direction.image;}
  ...
  final public String OrderKey() throws ParseException {Token key;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SIGNED_DECIMAL:{
      key = jj_consume_token(SIGNED_DECIMAL);
      break;
...
{if ("" != null) return timestamp.image;}
  ...
  private boolean jj_3_5()
 {
  ...
  public CriteriaGrammarTokenManager token_source;
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x40,0x4000000,0x3000,0x40000c8,0x40,0x4000000,0x3000,0x40000c8,0x200,0x100,0x88,0x1f03c00,0x0,0x80,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x18,0x80000018,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x1e00000,0x3400,0x80000000,0x80000000,0x20,0x60000000,0x3000,0x8000000,0x80000000,0x10000000,0x3000,0x60000000,0x0,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x740,0x7c0,0x0,0x0,0x740,0x7c0,0x0,0x0,0x7c0,0x0,0x7c0,0x3c0,0x7c0,0x780,0x3c,0x4,0xc0,0x3c,0x3c,0xfc0,0xfc0,0x60fc0,0x60fc0,0x380,0x3c,0x4,0xc0,0x3c,0x3c,0xfc0,0xfc0,0x0,0x0,0xbc0,0xbc0,0x0,0x0,0x740,0x0,0x40,0x0,0x0,0x0,0x740,};
	}
  ...
  public CriteriaGrammar(java.io.InputStream stream, String encoding) {
	 try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
	 token_source = new CriteriaGrammarTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public CriteriaGrammar(java.io.Reader stream) {
 ...
 token_source = new CriteriaGrammarTokenManager(jj_input_stream);
  ...
  public CriteriaGrammar(CriteriaGrammarTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(CriteriaGrammarTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jjtree.reset();
