...
String raw = t.image;
    ...
    prefix = NavigationKeySymbol.parseScopePrefix(path);
...
if(ts == null) {
    ...
    if(result instanceof NavigationKeySymbol) {
      {if ("" != null) return NavigationKeySymbol.withTimestampOnLastStop(
          (NavigationKeySymbol) result, ts);}
    }
    {if ("" != null) return new TemporalKeySymbol(result, ts);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return cmd;}
  ...
  final public CommandSymbol AddCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "add command");
    jj_consume_token(AS);
    value = UnaryValue();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IN:
...
{if ("" != null) return new AddSymbol(key, value);}
  ...
  final public CommandSymbol SetCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "set command");
    jj_consume_token(AS);
    value = UnaryValue();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IN:{
...
{if ("" != null) return new SetSymbol(key, value, Long.parseLong(record.image));}
  ...
  final public CommandSymbol RemoveCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "remove command");
    jj_consume_token(AS);
    value = UnaryValue();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case FROM:{
...
{if ("" != null) return new ClearSymbol((KeyTokenSymbol<?>)null, records);}
      ...
      keys = KeyCollection();
KeyTokenSymbol.requireBareKeys(keys, "clear command");
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case FROM:{
        jj_consume_token(FROM);
        break;
...
{if ("" != null) return new ClearSymbol(keys, Long.parseLong(record.image));}
      ...
      key = Key();
KeyTokenSymbol.requireBareKey(key, "clear command");
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case FROM:{
        jj_consume_token(FROM);
        break;
...
{if ("" != null) return new ClearSymbol((KeyTokenSymbol<?>)null, Long.parseLong(record.image));}
  ...
  final public CommandSymbol VerifyAndSwapCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "verify_and_swap command");
    jj_consume_token(AS);
    expected = UnaryValue();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IN:{
...
{if ("" != null) return new VerifyAndSwapSymbol(key, expected, replacement, Long.parseLong(record.image));}
  ...
  final public CommandSymbol VerifyOrSetCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "verify_or_set command");
    jj_consume_token(AS);
    value = UnaryValue();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IN:{
...
{if ("" != null) return cmd;}
  ...
  final public CommandSymbol LinkCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "link command");
    jj_consume_token(FROM);
...
Collection dest = new ArrayList();
  ...
  final public CommandSymbol UnlinkCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "unlink command");
    jj_consume_token(FROM);
    source = jj_consume_token(NUMERIC);
    jj_consume_token(TO);
    destination = jj_consume_token(NUMERIC);
...
{if ("" != null) return new FindSymbol(timestamp);}
  ...
  final public CommandSymbol FindOrAddCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "find_or_add command");
    jj_consume_token(AS);
    value = UnaryValue();
...
{if ("" != null) return new BrowseSymbol(keys, timestamp);}
  ...
  final public CommandSymbol ChronicleCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "chronicle command");
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IN:{
      jj_consume_token(IN);
      break;
...
{if ("" != null) return new ChronicleSymbol(key, Long.parseLong(record.image), start, end);}
  ...
  final public CommandSymbol DiffCommand() throws ParseException {KeyTokenSymbol<?> key = null;
    ...
    if (jj_2_57(4)) {
      key = Key();
KeyTokenSymbol.requireBareKey(key, "diff command");
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IN:{
        jj_consume_token(IN);
        break;
...
{if ("" != null) return new NavigateSymbol(keys, Long.parseLong(record.image), timestamp);}
  ...
  final public CommandSymbol ReconcileCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    key = Key();
KeyTokenSymbol.requireBareKey(key, "reconcile command");
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IN:{
      jj_consume_token(IN);
      break;
...
{if ("" != null) return new ReconcileSymbol(key, Long.parseLong(record.image), values);}
  ...
  final public CommandSymbol AuditCommand() throws ParseException {KeyTokenSymbol<?> key = null;
    ...
    if (jj_2_62(2)) {
      key = Key();
KeyTokenSymbol.requireBareKey(key, "audit command");
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IN:{
        jj_consume_token(IN);
        break;
...
{if ("" != null) return AbortSymbol.INSTANCE;}
  ...
  final public CommandSymbol RevertCommand() throws ParseException {KeyTokenSymbol<?> key = null;
    ...
    if (jj_2_66(2147483647)) {
      keys = KeyCollection();
KeyTokenSymbol.requireBareKeys(keys, "revert command");
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IN:{
        jj_consume_token(IN);
        break;
...
{if ("" != null) return new RevertSymbol(keys, Long.parseLong(record.image), timestamp);}
      ...
      case ASTERISK_SUFFIXED_STRING:{
        key = Key();
KeyTokenSymbol.requireBareKey(key, "revert command");
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case IN:{
          jj_consume_token(IN);
          break;
  ...
  private boolean jj_3R_38()
 {
  ...
  static {
	...
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x8000,0x7000,0x0,0x3d00f000,0x0,0x8000,0x7000,0x0,0x3d00f000,0x0,0x0,0x7d000000,0x7c0,0x3d000000,0x0,0x0,0x7d000000,0x7c0,0x3d000000,0x1d000000,0x20000000,0x3d000000,0x1d000000,0x20000000,0x3d000000,0x3d000000,0x3d200000,0x3d000000,0x3d000000,0x3d200000,0x1d000000,0x1d200000,0x3d000000,0x3d200000,0x780,0x0,0xc0000,0x1d200000,0x0,0x1d200000,0x0,0x1d200000,0x1d200000,0x0,0x1d200000,0x4000,0x3000,0x7000,0x3000,0x2000000,0x30000,0x3d000000,0x0,0x0,0x30000,0x10000000,0x3d000000,0x3c000000,0x2000000,0x3c000000,0x5000000,0x2000000,0x5000000,0x5000000,0x2000000,0x5000000,0x5000000,0x3c000000,0x2000000,0x3c000000,0x0,0x0,0x0,0x1000000,0x0,0x0,0x1000000,0x0,0x1000000,0x0,0x1000000,0x0,0x1000000,0x1000000,0x0,0x0,0x0,0x1000000,0x0,0x0,0x1000000,0x0,0x0,0x0,0x0,0x8000,0x7000,0x0,0x8000,0x7000,0x1000000,0x0,0x8000,0x7000,0x0,0x0,0x0,0x8000,0x7000,0x0,0x8000,0x7000,0x1000000,0x0,0x8000,0x7000,0x0,0x0,0x8000,0x7000,0x0,0x0,0x0,0x1000000,0x0,0x8000,0x7000,0x0,0x8000,0x7000,0x0,0x0,0x8000,0x7000,0x0,0x8000,0x7000,0x1000000,0x0,0x0,0x8000,0x7000,0x0,0x8000,0x7000,0x1000000,0x0,0x8000,0x7000,0x0,0x0,0x8000,0x7000,0x0,0x8000,0x7000,0x1000000,0x0,0x0,0x0,0x0,0x1000000,0x0,0x8000,0x7000,0x0,0x0,0x0,0x0,0x0,0x3d000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3d000000,0x1000000,0x0,0x0,0x3d000000,0x0,0x0,0x0,0x0,0x1000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000000,0x0,0x0,0x1000000,0x0,0x1000000,0x3d000000,0x0,0x1000000,0x1000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x2000000,0x3d200000,0x2000000,0x2000000,0x1000000,0x2000000,0x2000000,0x3d000000,};
	}
