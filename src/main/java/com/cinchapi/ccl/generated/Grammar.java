...
public class Grammar/*@bgen(jjtree)*/implements GrammarTreeConstants, GrammarConstants {/*@bgen(jjtree)*/
  protected JJTGrammarState jjtree = new JJTGrammarState();private Multimap<String, Object> data;
    ...
    public List<ASTStart> generateASTs() throws ParseException {
        List<ASTStart> statements = new ArrayList<ASTStart>();
        // Skip any leading semicolons
        while(getToken(1).kind == GrammarConstants.SEMICOLON) {
            jj_consume_token(GrammarConstants.SEMICOLON);
        }
        if(getToken(1).kind != GrammarConstants.EOF) {
            ASTStart first = generateStatement();
            statements.add(first);
            while(getToken(1).kind != GrammarConstants.EOF) {
                jj_consume_token(GrammarConstants.SEMICOLON);
                ...
                ASTStart next = generateStatement();
                statements.add(next);
            }
        }
        jj_consume_token(GrammarConstants.EOF);
        return statements;
    }
...
// Used by unit tests to parse a single statement (expects EOF)
...
if (jjtc000) {
  ...
  final public ASTStart generateStatement() throws ParseException {/*@bgen(jjtree) Start */
  ASTStart jjtn000 = new ASTStart(JJTSTART);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
...
if (jjtc001) {
  ...
  final public void StrictExpression() throws ParseException {/*@bgen(jjtree) Strict */
  ASTStrict jjtn000 = new ASTStrict(JJTSTRICT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
...
// --- No-timestamp expression variants ---
// These four productions mirror DisjunctionExpression, ConjunctionExpression,
// UnaryExpression, and RelationalExpression but suppress expression-level
// timestamps. They exist so FindOrInsertCommand can parse its criteria without
// the last RelationalExpression greedily consuming the command-level timestamp.
//
// Parenthesised sub-expressions delegate back to DisjunctionExpression (the
// full variant), so expression-level timestamps inside parentheses still work:
//   findOrInsert (age > 25 at "yesterday") at "2024-01-01" "{...}"
//
// MAINTENANCE: if the original expression productions change (e.g. new operator
// types in RelationalExpression), update RelationalExpressionNoTimestamp to
// match — the only difference should be the absence of the optional Timestamp()
// call.
  final public 
void DisjunctionExpressionNoTimestamp() throws ParseException {
    ConjunctionExpressionNoTimestamp();
    label_3:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case DISJUNCTION:{
...
if (jjtc001) {
  ...
  final public void ConjunctionExpressionNoTimestamp() throws ParseException {
    UnaryExpressionNoTimestamp();
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case CONJUNCTION:{
...
if (jjtc001) {
  ...
  final public void UnaryExpressionNoTimestamp() throws ParseException {
    if (jj_2_9(2)) {
      StrictExpression();
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      ...
      case PERIOD_SEPARATED_STRING:
      case ASTERISK_SUFFIXED_STRING:{
        RelationalExpressionNoTimestamp();
        break;
        }
      default:
        jj_la1[17] = jj_gen;
  ...
  final public void RelationalExpressionNoTimestamp() throws ParseException {/*@bgen(jjtree) Expression */
    ASTExpression jjtn000 = new ASTExpression(JJTEXPRESSION);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);KeyTokenSymbol key = null;
    OperatorSymbol operator = null;
...
if (jjtc000) {
  ...
  final public KeyTokenSymbol SearchKey() throws ParseException {Token key;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case RESERVED_IDENTIFIER:
    case NUMERIC:
    case SIGNED_INTEGER:
...
{if ("" != null) return new KeySymbol(key.image);}
    ...
    case ASTERISK_SUFFIXED_STRING:{
      ...
      case ASTERISK_SUFFIXED_STRING:{
        key = jj_consume_token(ASTERISK_SUFFIXED_STRING);
        break;
        }
      default:
        jj_la1[21] = jj_gen;
...
{if ("" != null) return new ValueSymbol(transformValue(word.image.replace("\\\"", "\"")));}
  ...
  final public ValueTokenSymbol SearchValue() throws ParseException {FunctionValueSymbol function;
  Token key;
  Token word;
  String value = "";
  List<String> records = Lists.newArrayList();
...
{if ("" != null) return new OperatorSymbol(transformOperator(operator.image));}
  ...
  final public OperatorSymbol SearchOperator() throws ParseException {Token operator;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SEARCH_MATCH:{
      operator = jj_consume_token(SEARCH_MATCH);
      break;
      }
    case SEARCH_EXCLUDE:{
      operator = jj_consume_token(SEARCH_EXCLUDE);
      break;
      }
    default:
      jj_la1[37] = jj_gen;
...
{if ("" != null) return new TimestampSymbol(NaturalLanguage.parseMicros(timestamp));}
  ...
  final public TimestampSymbol TimestampValue() throws ParseException {Token word;
  String timestamp = "";
    label_11:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
// Single-token timestamp variant used by FindOrInsertCommand, where the
// multi-token greedy loop of TimestampReadCommand would consume the trailing
// JSON QUOTED_STRING. This production accepts exactly one value token after the
// timestamp keyword.
  final public TimestampSymbol TimestampSingleToken() throws ParseException {Token word;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case TIMESTAMP:{
      jj_consume_token(TIMESTAMP);
      break;
...
{if ("" != null) return new TimestampSymbol(NaturalLanguage.parseMicros(word.image));}
    throw new Error("Missing return statement in function");
}
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);String skip = null;
  String limit = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case OFFSET:
...
jjtree.closeNodeScope(jjtn000, true);
      jjtc000 = false;
jjtn000.page(PageSymbol.fromSkipLimit(Integer.parseInt(skip), limit != null ? Integer.parseInt(limit) : null));
        break;
        }
      case LIMIT:{
        limit = Limit();
...
jjtree.closeNodeScope(jjtn000, true);
      jjtc000 = false;
jjtn000.page(PageSymbol.fromSkipLimit(skip != null ? Integer.parseInt(skip) : 0, Integer.parseInt(limit)));
        break;
        }
      default:
        jj_la1[46] = jj_gen;
...
if (jjtc000) {
  ...
  final public String Offset() throws ParseException {Token offset;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case OFFSET:{
    ...
    offset = jj_consume_token(NUMERIC);
{if ("" != null) return offset.image;}
    throw new Error("Missing return statement in function");
}

  final public String Limit() throws ParseException {Token limit;
    jj_consume_token(LIMIT);
    limit = jj_consume_token(NUMERIC);
{if ("" != null) return limit.image;}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return new AddSymbol(key, value);}
  ...
  final public CommandSymbol SetCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    if (jj_2_26(2147483647)) {
      records = RecordCollection();
{if ("" != null) return new SetSymbol(key, value, records);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case NUMERIC:{
        record = jj_consume_token(NUMERIC);
...
Collection dest = new ArrayList();
  ...
  final public CommandSymbol UnlinkCommand() throws ParseException {KeyTokenSymbol<?> key;
    ...
    jj_consume_token(TO);
    destination = jj_consume_token(NUMERIC);
{if ("" != null) return new UnlinkSymbol(key, Long.parseLong(source.image), Long.parseLong(destination.image));}
    throw new Error("Missing return statement in function");
}
  ...
  final public CommandSymbol QueryOperations() throws ParseException {CommandSymbol cmd;
    ...
    case FIND_OR_ADD:{
      cmd = FindOrAddCommand();
      break;
      }
    case FIND_OR_INSERT:{
      cmd = FindOrInsertCommand();
      break;
      }
    case DESCRIBE:{
      cmd = DescribeCommand();
...
{if ("" != null) return new SelectSymbol(null, records, timestamp);}
...
{if ("" != null) return new SelectSymbol(null, timestamp);}
        break;
        }
      default:
        jj_la1[121] = jj_gen;
...
{if ("" != null) return new SelectSymbol(null, records, timestamp);}
          ...
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case NUMERIC:{
            // Single record (no keys) — select 1
                    record = jj_consume_token(NUMERIC);
            switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
            case AS_OF:
            case TIMESTAMP:{
...
{if ("" != null) return new SelectSymbol(null, Long.parseLong(record.image), timestamp);}
            break;
            }
          default:
            jj_la1[122] = jj_gen;
...
{if ("" != null) return new GetSymbol(null, timestamp);}
        break;
        }
      case IN:
      case WITHIN:
...
{if ("" != null) return new GetSymbol(null, records, timestamp);}
        } else {
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case NUMERIC:{
            record = jj_consume_token(NUMERIC);
...
{if ("" != null) return new GetSymbol(null, Long.parseLong(record.image), timestamp);}
            break;
            }
          default:
            jj_la1[155] = jj_gen;
...
{if ("" != null) return new FindSymbol(timestamp);}
  ...
  final public CommandSymbol FindOrAddCommand() throws ParseException {KeyTokenSymbol<?> key;
    ValueTokenSymbol<?> value;
...
{if ("" != null) return new FindOrAddSymbol(key, value);}
  ...
  final public CommandSymbol FindOrInsertCommand() throws ParseException {Token json = null;
    TimestampSymbol timestamp = null;
    jj_consume_token(FIND_OR_INSERT);
    DisjunctionExpressionNoTimestamp();
    if (jj_2_53(2147483647)) {
      timestamp = TimestampSingleToken();
    } else {
      ;
    }
    json = jj_consume_token(QUOTED_STRING);
{if ("" != null) return new FindOrInsertSymbol(
                json.image.substring(1, json.image.length() - 1),
                timestamp);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return new DescribeSymbol(timestamp);}
    }
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return new SearchSymbol(key, transformValue(query.image).toString());}
  ...
  final public CommandSymbol BrowseCommand() throws ParseException {KeyTokenSymbol<?> key = null;
    Collection<KeyTokenSymbol<?>> keys = null;
    TimestampSymbol timestamp = null;
...
{if ("" != null) return new BrowseSymbol(keys, timestamp);}
  ...
  final public CommandSymbol ChronicleCommand() throws ParseException {KeyTokenSymbol<?> key;
    Token record;
...
{if ("" != null) return new DiffSymbol(null, Long.parseLong(record.image), start, end);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case RESERVED_IDENTIFIER:
      case NUMERIC:
...
{if ("" != null) return new DiffSymbol(key, start, end);}
        break;
        }
      default:
        jj_la1[178] = jj_gen;
...
if(record != null) {
            {if ("" != null) return new JsonifySymbol(Long.parseLong(record.image), null, timestamp, identifier);}
        } else {
            {if ("" != null) return new JsonifySymbol(null, records, timestamp, identifier);}
        }
    throw new Error("Missing return statement in function");
}

  final public CommandSymbol NavigateCommand() throws ParseException {KeyTokenSymbol<?> key = null;
    Collection<KeyTokenSymbol<?>> keys = null;
    Token record = null;
    Collection<Long> records = null;
    TimestampSymbol timestamp = null;
...
{if ("" != null) return new ReconcileSymbol(key, Long.parseLong(record.image), values);}
  ...
  final public CommandSymbol AuditCommand() throws ParseException {KeyTokenSymbol<?> key = null;
    Token record;
    TimestampSymbol start = null;
    TimestampSymbol end = null;
...
// Utility Operations
  final public CommandSymbol UtilityOperations() throws ParseException {CommandSymbol cmd;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PING:{
      cmd = PingCommand();
      break;
...
{if ("" != null) return cmd;}
  ...
  final public CommandSymbol PingCommand() throws ParseException {
    jj_consume_token(PING);
{if ("" != null) return PingSymbol.INSTANCE;}
    throw new Error("Missing return statement in function");
}

  final public CommandSymbol HoldsCommand() throws ParseException {Token record;
    Collection<Long> records;
    jj_consume_token(HOLDS);
    if (jj_2_67(2147483647)) {
      records = RecordCollection();
{if ("" != null) return new HoldsSymbol(records);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case NUMERIC:{
        record = jj_consume_token(NUMERIC);
{if ("" != null) return new HoldsSymbol(Long.parseLong(record.image));}
        break;
        }
      default:
        jj_la1[203] = jj_gen;
  ...
  final public CommandSymbol ConsolidateCommand() throws ParseException {Token first;
    Token second;
    Collection<Long> remaining = null;
    jj_consume_token(CONSOLIDATE);
    first = jj_consume_token(NUMERIC);
    if (jj_2_68(2147483647)) {
      remaining = RecordCollection();
{if ("" != null) return new ConsolidateSymbol(Long.parseLong(first.image), remaining);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case NUMERIC:{
        second = jj_consume_token(NUMERIC);
Collection<Long> others = new ArrayList<Long>();
            others.add(Long.parseLong(second.image));
            {if ("" != null) return new ConsolidateSymbol(Long.parseLong(first.image), others);}
        break;
        }
      default:
        jj_la1[204] = jj_gen;
  ...
  final public CommandSymbol CalculateCommand() throws ParseException {Token function;
    KeyTokenSymbol<?> key;
    Token record = null;
    Collection<Long> records = null;
    TimestampSymbol timestamp = null;
    jj_consume_token(CALCULATE);
    function = jj_consume_token(ALPHANUMERIC);
    key = Key();
...
{if ("" != null) return new CalculateSymbol(function.image, key, records, timestamp);}
...
{if ("" != null) return new CalculateSymbol(function.image, key, timestamp);}
        break;
        }
      default:
        jj_la1[211] = jj_gen;
...
{if ("" != null) return transformValue(content.image).toString();}
  ...
  private boolean jj_3R_76()
 {
  ...
  private int jj_la;
  private int jj_gen;
  final private int[] jj_la1 = new int[221];
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x0,0x0,0xfffffff8,0x0,0x0,0x0,0x0,0xfffffff8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xfffffff8,0x1f8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc00,0x0,0x1ffff000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0000000,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x2000000,0x0,0x0,0x1f,0x0,0x2000000,0x0,0x0,0x1f,0x0,0x10000000,0x8000000,0x4100000,0xe0000000,0x4000000,0x10000000,0x8000000,0x4100000,0xe0000000,0x4000000,0x4000000,0x0,0x4000000,0x4000000,0x0,0x4000000,0x0,0x0,0x0,0x0,0x100000,0x0,0x0,0x0,0x0,0x0,0xa0000000,0x0,0x0,0x1000400,0x0,0x0,0x1000400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x84000000,0x1000000,0x80000000,0x0,0x0,0x0,0x0,0x200000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400000,0x0,0x200000,0x0,0x1f,0x0,0x2a0,0x0,0x2a0,0xa0,0x0,0x1a0,0x0,0x1a0,0x0,0x1a0,0x0,0x0,0xa0,0xa0,0x2e0,0x0,0x2e0,0x0,0x0,0x0,0x1000400,0x1a0,0x1000400,0x0,0x0,0x1000400,0x0,0x0,0x0,0x1000400,0x0,0x0,0x2000000,0x1a0,0x1000400,0x0,0x0,0x1000400,0x0,0x0,0x0,0x1000400,0x0,0x0,0x2000000,0x1000400,0x0,0x0,0x1000400,0x1000400,0x2000000,0x0,0x1000400,0x0,0x0,0x1000400,0x0,0x0,0x1a0,0x1000400,0x0,0x0,0x1000400,0x0,0x0,0x0,0x1a0,0x1000400,0x0,0x0,0x1000400,0x0,0x0,0x0,0x1000400,0x0,0x0,0x1a0,0x1000400,0x0,0x0,0x1000400,0x0,0x0,0x0,0x1000400,0x1000400,0x1000400,0x20001a0,0x0,0x1000400,0x0,0x0,0x1000400,0x1000400,0x1000400,0xa0,0x1000400,0x4000000,0x1000400,0xa0,0x200,0x100,0xa0,0x200,0x200,0x200,0x4000000,0x0,0x4000,0x1000400,0x4000000,0x1000400,0x1a0,0x1000400,0x1000400,0x0,0x20001a0,0xa0,0xa0,0x200,0x100,0x1000400,0x1000400,0x0,0x1,0xa0,0x0,0xa0,0x0,0x4000000,0x1c,0x0,0x0,0x1a0,0x1000400,0x1a0,0x1000400,0x1000400,0x1000400,0x2000000,0x0,0x0,0x400000,0x0,0x0,0x400000,0x0,0x0,0x4400000,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x10000,0xe000,0x0,0xfa01e000,0x0,0x10000,0xe000,0x0,0xfa01e000,0x0,0x0,0xfa000000,0xf81,0xfa000000,0x0,0x0,0xfa000000,0xf81,0xfa000000,0x3a000000,0xc0000000,0xfa000000,0x3a000000,0xc0000000,0xfa000000,0xfa000000,0xfa400000,0xfa000000,0xfa000000,0xfa400000,0xba000000,0xba400000,0xfa000000,0xfa400000,0xf00,0x1,0x180000,0xba400000,0x0,0xba400000,0xba400000,0x0,0xba400000,0x8000,0x6000,0xe000,0x6000,0x4000000,0x60000,0xfa000001,0x0,0x1,0x60000,0x20000000,0xfa000000,0xf8000000,0x4000000,0xf8000000,0xa000000,0x4000000,0xa000000,0xa000000,0x4000000,0xa000000,0xa000000,0xf8000000,0x4000000,0xf8000000,0x0,0x0,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x2000000,0x0,0x2000000,0x2000000,0x0,0x0,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x0,0x0,0x0,0x10000,0xe000,0x0,0x10000,0xe000,0x2000000,0x0,0x10000,0xe000,0x0,0x0,0x0,0x10000,0xe000,0x0,0x10000,0xe000,0x2000000,0x0,0x10000,0xe000,0x0,0x0,0x10000,0xe000,0x0,0x0,0x0,0x2000000,0x0,0x10000,0xe000,0x0,0x10000,0xe000,0x0,0x0,0x10000,0xe000,0x0,0x10000,0xe000,0x2000000,0x0,0x0,0x10000,0xe000,0x0,0x10000,0xe000,0x2000000,0x0,0x10000,0xe000,0x0,0x0,0x10000,0xe000,0x0,0x10000,0xe000,0x2000000,0x0,0x0,0x0,0x0,0x2000000,0x0,0x10000,0xe000,0x0,0x0,0x0,0x0,0x0,0xfa000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xfa000000,0x2000000,0x0,0x0,0xfa000000,0x0,0x0,0x0,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x0,0x0,0x2000000,0x0,0x2000000,0xfa000000,0x0,0x2000000,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000000,0x4000000,0xfa400000,0x4000000,0x4000000,0x2000000,0x4000000,0x4000000,0xfa000000,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0xc1,0xc1,0xc1,0x1,0x1,0x1,0x1,0x0,0x0,0x0,0x1,0x0,0x1,0x1,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
